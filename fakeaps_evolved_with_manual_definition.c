...
uint8_t* constructBeaconPacket( uint8_t dataRate, uint8_t channel, const struct AccessPointDescriptor* apDescription, size_t* beaconLength, char version )
{
	...
	if ((version == 'v') || (version == 'a'))
		version = 'n'; //No hacer nada y por ello lo paso a 'n'
...
void help()
{
	printf( "$ ./fakeaps_evolved [atheros raw device] [channel it is tuned to] [802.11 version: 'g' (11g), 'n' (11n), 'v' (11ac), 'a' (send AMPDUs)] [mode: 'p' (program-built frame. Only for 11g and 11n), 'u' (user-defined frame)]\n" );
}
...
int main(int argc, char *argv[])
{
	...
	// Manual definition of the different frames

	// 802.11g probe
	uint8_t* wifi_frame_probe = "";
	size_t length_wifi_frame_probe = 79;

	// 802.11g beacon
	uint8_t* wifi_frame_beacon = "\x00\x00\x09\x00\x00\x00\x00\x04\x04\x80\x00\x00\x00\xff\xff\xff\xff\xff\xff\xf4\xf2\x6d\x0c\x9d\xaa\xf4\xf2\x6d\x0c\x9d\xaa\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x64\x00\x01\x00\x03\x61\x70\x30\x01\x04\x82\x84\x0b\x16\x03\x01\x01";
	size_t length_wifi_frame_beacon = 59;

	// 802.11 beacon with padding
	// Padding goes after Rate in order to let tha MAC start in the middle of the second group
	uint8_t* wifi_frame_beacon_rate = "\x00\x00\x0c\x00\x04\x00\x00\x00\x12\x00\x00\x00\x80\x00\x00\x00\x74\x70\xfd\xe4\x10\x11\xf4\xf2\x6d\x0c\x9d\xaa\xf4\xf2\x6d\x0c\x9d\xaa\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x64\x00\x01\x00\x03\x61\x70\x30\x01\x04\x82\x84\x0b\x16\x03\x01\x01";
	size_t length_wifi_frame_beacon_rate = 62; 

	// Padding after MCS in order to let tha MAC start in the middle of the second group
	//uint8_t* wifi_frame_beacon_mcs = "\x00\x00\x0c\x00\x00\x00\x08\x00\x07\x00\x0e\x00\x40\x00\x00\x00\xff\xff\xff\xff\xff\xff\xf4\xf2\x6d\x0c\x9d\xaa\xf4\xf2\x6d\x0c\x9d\xaa\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x64\x00\x01\x00\x03\x61\x70\x30\x01\x04\x82\x84\x0b\x16\x03\x01\x01";
	uint8_t* wifi_frame_beacon_mcs = "\x00\x00\x0c\x00\x00\x00\x08\x00\x07\x00\x07\x00\x80\x00\x00\x00\x74\x70\xfd\xe4\x10\x11\xf4\xf2\x6d\x0c\x9d\xaa\xf4\xf2\x6d\x0c\x9d\xaa\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x64\x00\x01\x00\x03\x61\x70\x30\x01\x04\x82\x84\x0b\x16\x03\x01\x01";
	size_t length_wifi_frame_beacon_mcs = 62;

	// Padding after MCS+Spatialstream in order to let tha MAC start in the middle of the second group     --padding---
	//uint8_t* wifi_frame_beacon_vht = "";
	uint8_t* wifi_frame_beacon_vht = "";
	size_t length_wifi_frame_beacon_vht = 70;

	// AMPDUs - not working yet
	// this is a frame with 3 AMPDUs generated with matlab (132 bytes) It includes FCSs
	// \x70\x02\x9C\x4E\x88\x02\x00\x00\xFF\xFF\xFF\xFF\xFF\xFF\x00\x12\x34\x56\x78\x9B\x00\x12\x34\x56\x78\x9B\x00\x00\x20\x00\x00\x57\x60\x00\x10\x3A\xFF\xFE\x80\x8E\x2A\x43\x13\x00
	// \x70\x02\x9C\x4E\x88\x02\x00\x00\xFF\xFF\xFF\xFF\xFF\xFF\x00\x12\x34\x56\x78\x9B\x00\x12\x34\x56\x78\x9B\x10\x00\x20\x00\x02\x00\x00\xFF\xFE\x00\x00\x1F\xF0\x23\x5F\xA9\x18\x00
	// \x70\x02\x9C\x4E\x88\x02\x00\x00\xFF\xFF\xFF\xFF\xFF\xFF\x00\x12\x34\x56\x78\x9B\x00\x12\x34\x56\x78\x9B\x20\x00\x20\x00\x00\x2C\x0B\x0F\xFF\xE0\x00\x00\x1F\x8F\x39\x9A\x9E\x00

	// I assign both to the packet (remove FCSs and change to RADIOTAP MCS)
	uint8_t* wifi_frame_ampdu = "";
	//printf("%c\n", wifi_frame_ampdu);
	size_t length_wifi_frame_ampdu = 120 + 12;
	// end of - Manual definition of the different frames
	...
	if (strlen(argv[3]) != 1) {
		printf( "The version must be 'g', 'n', 'v' or 'a'.\n" );
		help();
		return 1;	
	}

	if ( (version != 'g') && (version != 'n') && (version != 'v') && (version != 'a') ) {
		printf( "The version must be 'g', 'n', 'v' or 'a'.\n" );
		help();
		return 1;
	}

	assert( (version == 'g') || (version == 'n') || (version == 'v') || (version == 'a') );
	...
	if (strlen(argv[4]) != 1) {
		printf( "The mode must be 'p' or 'u'.\n" );
		help();
		return 1;	
	}
	...
	// check the coherence between the parameters
	if ( (mode == 'p') && ((version == 'v') || (version == 'a')) ) {
		printf("mode: 'p' (program-built frame) only available for 11g and 11n");
		help();
		return 1;
	}
	...
	if (version == 'g') {
		printf("802.11g selected\n", version );		
	} else if (version == 'n') {
		printf("802.11n selected\n", version );		
	} else if (version == 'v') {
		printf("802.11ac selected\n", version );		
	} else if (version == 'a') {
		printf("802.11 sending AMPDUs selected\n", version );		
	} else {
		return 1;
	}

	if (mode == 'p') {
		printf("mode 'p': program-built frame selected\n");
	} else if (mode == 'u') {
		printf("mode 'u': the program will send frames defined manually byte-by-byte in the code\n");
	} else {
		return 1;
	}
	...
	while ( 1 )
	{
		...
		// 2. The beacon interval (102400 microseconds) has expired => send a beacon
		fd_set readfds;
		FD_ZERO( &readfds );
		...
		if ( numFds == 1 )
		{
			...
			// you can select if you want to receive frames
			int decode_received_frames = 0;			
			if (decode_received_frames == 1) {
		...
		if ( compareTimeval( &beaconTime, &now ) <= 0 )
		{
			...
			for ( i = 0; i < numAccessPoints; ++ i )
			{
				ssize_t bytes;	// bytes really sent

				if (mode == 'p') {
					// send beacons built by the program
					bytes = write( rawSocket, beaconPackets[i], beaconLengths[i] );
					assert( bytes == (ssize_t) beaconLengths[i] );
					packet_hexdump( (const uint8_t*) beaconPackets[i], beaconLengths[i] );

					// check if we have correctly sent the frame
					...
					// send manually defined probes
					if (0) {
						bytes = write( rawSocket, wifi_frame_probe, length_wifi_frame_probe );
						assert( bytes == (ssize_t) length_wifi_frame_probe);
						packet_hexdump( wifi_frame_probe, length_wifi_frame_probe );						

						// check if we have correctly sent the frame
						if ( bytes < length_wifi_frame_probe )
						{
							perror( "error sending packet" );
							return 1;
						}
					...
					// send manually defined beacons
					if (0) {
						bytes = write( rawSocket, wifi_frame_beacon, length_wifi_frame_beacon );
						assert( bytes == (ssize_t) length_wifi_frame_beacon);
						packet_hexdump( wifi_frame_beacon, length_wifi_frame_beacon );						

						// check if we have correctly sent the frame
						if ( bytes < length_wifi_frame_beacon )
						{
							perror( "error sending packet" );
							return 1;
						}
					...
					// send manually defined 11g beacons with rate
					if (version == 'g') {	
						bytes = write( rawSocket, wifi_frame_beacon_rate, length_wifi_frame_beacon_rate );
						assert( bytes == (ssize_t) length_wifi_frame_beacon_rate);
						packet_hexdump( wifi_frame_beacon_rate, length_wifi_frame_beacon_rate );	

						// check if we have correctly sent the frame
						if ( bytes < length_wifi_frame_beacon_rate )
						{
							perror( "error sending packet" );
							return 1;
						}
					...
					// send manually defined 11n beacons with MCS
					else if (version == 'n') {
						bytes = write( rawSocket, wifi_frame_beacon_mcs, length_wifi_frame_beacon_mcs );
						assert( bytes == (ssize_t) length_wifi_frame_beacon_mcs);
						packet_hexdump( wifi_frame_beacon_mcs, length_wifi_frame_beacon_mcs );

						// check if we have correctly sent the frame
						if ( bytes < length_wifi_frame_beacon_mcs )
						{
							perror( "error sending packet" );
							return 1;
						}
					...
					// send manually defined 11ac beacons with VHT
					else if (version == 'v') {
						bytes = write( rawSocket, wifi_frame_beacon_vht, length_wifi_frame_beacon_vht );
						assert( bytes == (ssize_t) length_wifi_frame_beacon_vht);
						packet_hexdump( wifi_frame_beacon_vht, length_wifi_frame_beacon_vht );

						// check if we have correctly sent the frame
						if ( bytes < length_wifi_frame_beacon_vht )
						{
							perror( "error sending packet" );
							return 1;
						}
					...
					// send manually defined AMPDUs (not working yet)
					else if (version == 'a') {
						bytes = write( rawSocket, wifi_frame_ampdu, length_wifi_frame_ampdu );
						assert( bytes == (ssize_t) length_wifi_frame_ampdu);
						packet_hexdump( wifi_frame_ampdu, length_wifi_frame_ampdu );

						// check if we have correctly sent the frame
						if ( bytes < length_wifi_frame_ampdu )
						{
							perror( "error sending packet" );
							return 1;
						}
